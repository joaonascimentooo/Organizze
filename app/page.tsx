  ...
  return (
    <div className="app-shell">
      ...
      >
        ...
        <section className={`summary-grid ${loading ? "is-loading" : ""}`} id="inicio">
        ...
        <section className={`content-grid ${view !== "overview" ? "focused-content" : ""}`}>
          {view === "overview" && <>
          ...
          {view === "expenses" && <article className="panel list-panel focused-list" id="gastos">
            <div className="panel-heading"><div><span className="eyebrow">MOVIMENTAÇÕES</span><h2>Gastos recentes</h2></div><button className="text-button" onClick={() => setModal("expense")}><Icon name="plus" size={17}/>Adicionar</button></div>
